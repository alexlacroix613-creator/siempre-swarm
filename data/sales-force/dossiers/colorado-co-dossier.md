...
- Population Context: ~5.8M residents. Denver/Boulder metro (~3.5M) is the dominant market. Fort Collins (craft beverage culture), Colorado Springs, Aspen/Vail/Telluride (ultra-premium resort corridor).
- Key Channels: On-premise (Denver RiNo, LoDo, South Broadway cocktail bars; Boulder Pearl Street; Aspen resort dining), off-premise (Total Wine Denver, Molly's Spirits — CO's leading independent, King Soopers, Whole Foods)
- Spirits context: CO has a highly educated, craft-oriented consumer base. Denver is a genuine cocktail culture city. Boulder skews premium/organic. Aspen/Vail corridor = ultra-premium placement.
...
- Colorado Liquor Enforcement Division (LED) governs
- No franchise law complications
- Brand/label registration: TTB federal + CO state registration through LED
- DAs: Permitted in CO
...
**Escalation Triggers:**
- LED compliance events
- Aspen/Vail resort account exclusives (verify tied-house rules)
...
| Person | Role with CO | Contact |
|--------|-------------|---------|
| Alex Lacroix | CEO — primary owner, pricing, market visits | alex@siempretequila.com |
...
|--------|--------|--------|---------|--------|
| % to depletion target (120 9L-eq/yr) | 30 pts | 100% | TBD — pull VIP iDig | — |
| Reorder rate (90-day window) | 20 pts | ≥40% PODs | TBD | — |
| Pipeline coverage | 20 pts | ≥6 weeks | TBD | — |
| Core SKU mix (Plata+Repo co-present) | 15 pts | ≥60% PODs | TBD | — |
| Spend per case | 15 pts | ≥$12/9L-eq | TBD | — |

**Annual volume target:** 120 9L-eq cases/year
**POD target:** 60+ active accounts (Denver/Boulder heavy; Aspen/Vail premium placements)
**Priority SKU:** Plata + Reposado in Denver. Añejo for Aspen/Vail resort dining.
**Molly's Spirits:** Key off-premise anchor — confirm listing and explore tasting event.

> ⚠️ All current metrics TBD. Pull VIP iDig CO data before scoring.

---

## 6. PRICING ARCHITECTURE

**SRP Targets (CO — standard license state):**
- Plata: $45–$50
- Reposado: $54–$58
- Añejo: $90–$95
...
> 5. Any Aspen/Vail placements active?
...
| City | Status | Notes |
|------|--------|-------|
| **Denver** | ⚠️ VERIFY | RiNo, LoDo, South Broadway cocktail scene. Molly's Spirits. Top priority. |
